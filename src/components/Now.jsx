...
export default function Now() {
  return (
    <section className="py-16 px-6 text-center text-gray-600">
      <h3 className="text-2xl font-serif mb-4">Now</h3>
      <p>
        I’m deep in product delivery for enterprise clients, balancing user needs, delivery constraints, and long‑term scalability.
      </p>
      <p className="mt-4">
        Catch me building, learning React, or tweaking this site at{' '}
